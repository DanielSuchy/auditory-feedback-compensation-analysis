...
%set_file = '/Users/diskuser/analysis/eeg_data/main/eeg/S1-2022-10-03T174648/S1_responses.set';
%participant_id = 'S1';
%path = '/Users/diskuser/analysis/eeg_data/main/eeg/S1-2022-10-03T174648';
...
audiodata_bin = [padding audiodata_bin];

trial_start = 500; % visualize audiodata N samples before the threshold is crossed
trial_end = 4000; % visualize audiodata N samples before the threshold is crossed
...
% plot(time_seconds, abs(EEG_audio.data), 'k','LineWidth', 1)
% for e = 1:length(EEG.event)
%     if strcmp(EEG.event(e).type, 'voice_onset')
%         line([EEG.event(e).latency*sample_length./1000 EEG.event(e).latency*sample_length./1000], [2000 -2000], 'Color', 'green', 'LineWidth', 3)
%     end
% end
% xlabel 'time (sec)'
...
% plot(time_seconds, abs(EEG_audio.data), 'k','LineWidth', 1)
% for e = 1:length(EEG.event)
%     if strcmp(EEG.event(e).type, 'PertOnset_aware')
%         line([EEG.event(e).latency*sample_length./1000 EEG.event(e).latency*sample_length./1000], [2000 -2000], 'Color', 'green', 'LineWidth', 3)
%     elseif strcmp(EEG.event(e).type, 'PertOnset_unaware')
%         line([EEG.event(e).latency*sample_length./1000 EEG.event(e).latency*sample_length./1000], [2000 -2000], 'Color', 'red', 'LineWidth', 3)
%     elseif strcmp(EEG.event(e).type, 'PertOnset')
%         line([EEG.event(e).latency*sample_length./1000 EEG.event(e).latency*sample_length./1000], [2000 -2000], 'Color', 'blue', 'LineWidth', 3)
%     end
% end
% xlabel 'time (sec)'
...
%% save
savename = [path '/' participant_id '_perts_onsets.set'];
